...
void main() {
  ...
  group('Custom errors', () {
    ...
    test('should throw an error', () {
      final rule = Rule(
        ...
        isEmail: true,
        customErrorText: 'This is a master error',
        customErrors: {'isEmail': 'Email is invalid.'},
      );
      final groupRule = GroupRule([rule], name: 'group name');
    ...
    test('should throw an error', () {
      ...
      final groupRule = GroupRule(
        ...
        maxAllowed: 0,
        customErrorText: 'This is a master group error',
        customErrors: {'maxAllowed': 'Group input is invalid.'},
      );
  ...
  group('requiredAll', () {
    test('should throw an error', () {
      ...
      expect(
        groupRule.error,
        contains('All fields are mandatory in group name'),
      );
      expect(groupRule.hasError, equals(true));
    });
  ...
  group('copyWith', () {
    ...
    test('should throw an error', () {
      final rule1 = Rule('qwerty123', name: 'value', shouldNotMatch: 'xyz');
    ...
    test('should throw an error', () {
      final rule1 = Rule('', name: 'value', shouldNotMatch: 'xyz');
      final rule2 = rule1.copyWith(name: 'value', shouldMatch: 'abc');
      final groupRule1 = GroupRule([rule1, rule2], name: 'group name');
      final groupRule2 = groupRule1.copyWith(requiredAll: true);
    ...
    test('should NOT throw an error', () {
      final rule1 = Rule('abc', name: 'value', shouldNotMatch: 'xyz');
      final rule2 = rule1.copyWith(name: 'value', shouldMatch: 'abc');
      final groupRule1 = GroupRule([rule1, rule2], name: 'group name');
      final groupRule2 = groupRule1.copyWith(
        requiredAll: true,
